...
kubectl apply -f prometheus_configuration/prometheus-rule.yaml

##### Grafana API key #####
# https://argo-cd.readthedocs.io/en/stable/operator-manual/notifications/services/grafana/
export GRAFANA_KEY=eyJrIjoiNXVaTFRVNW5DU3YxM1BjOEYzd0NTOVJWMXZPU2dtdHYiLCJuIjoiR1JBRkFOQV9LRVkiLCJpZCI6MX0=
kubectl apply -f prometheus_configuration/grafana-configmap.yaml
