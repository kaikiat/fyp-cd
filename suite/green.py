'''
    Green represents the preview/newer version
'''
import os
import logging
import subprocess
...
def main():
    cmd = r"kubectl get svc sgdecoding-online-scaled-master-preview -n ntuasr-production-google --output jsonpath='{.status.loadBalancer.ingress[0].ip}'"
