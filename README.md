...
5. (BlueGreen) Not sure if this step should take place before configuring blue green rollout ? Run `kubectl apply -f monitoring/manifests/service-monitor-ntuasr-preview.yaml -n ntuasr-production-google`
